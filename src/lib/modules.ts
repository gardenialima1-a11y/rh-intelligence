...
export const MODULES: ModuleDef[] = [
  ...
  { key: "contratos-temporarios", slug: "contratos-temporarios", name: "Contratos por Prazo Determinado", shortName: "Contratos", icon: Clock3, group: "Ciclo de Vida do Colaborador", description: "Jovem Aprendiz, Estágio e Temporário — alerta de vencimento." },
  { key: "periodo-experiencia", slug: "periodo-experiencia", name: "Período de Experiência", shortName: "Experiência", icon: UserCheck, group: "Ciclo de Vida do Colaborador", description: "Acompanhamento dos checkpoints de 30 e 90 dias." },
